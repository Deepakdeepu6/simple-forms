...
<div class="container" id='show'>
           <div class="row first ">
            ...
            <div class="row text-center">
              <p class='ml-2' style="font-family: 'Pangolin', cursive;font-size:1.8rem;">Education Information</p>
...
if(isset($_POST['send']))
{
    ...
    if(!empty($primary) && !empty($higher) && !empty($puc) && !empty($ug))
    {
    $sd="insert into education(primary1,higherprimary1,puc,undergraduation,ssid,ssemail,formno) values('$primary','$higher','$puc','$ug','$id','".$_SESSION['sessionemail']."','$formnumber')";
