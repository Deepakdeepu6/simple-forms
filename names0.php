...
<div class="container" id='show'>
  ...
  <input type="text" value="http://localhost:8080/forms/names.php?i=<?= $id ?>" id="myInput" style='opacity:0;'>
            ...
            <div class="row text-center">
              ...
              <hr >
                ...
                <div id="Responses" class="tabcontent col-12">
                 <?php
                 $sls="select * from contact where formnumber='$formnumber' and semail='".$_SESSION['email']."' order by time desc";
                    ...
                    while($row=mysqli_fetch_array($res))
                 {
                     ...
                     <div class='col-12 col-sm-6'>Name:<?php echo $row['cname'];?></div>
                     <div class='col-12 col-sm-6'>Contact:<?php echo $row['cnumber'];?></div>

                     </div>
                     
                     <div class='row retrived'>
                     <div class='col-12 col-sm-6'>Email:<?php echo $row['cemail'];?></div>
                     <div class='col-12 col-sm-6'>Address:<?php echo $row['caddress'];?></div>
                     </div>
                     <div class='row retrived'>
...
if($result1)
{
  ...
  window.location.href='names0.php?i=<?= $id?>';
  ...
  if($result)
  {
     ?>
      ...
      swal({
        ...
        if(okay)
         window.location.href="names0.php?i=<?php echo $id?>";
      });
       </script>
     <?php   
  }
